...
class employeeClass:
    def __init__(self,root):
        ...
        self.EmployeeTable=ttk.Treeview(emp_frame,columns=("eid","name","email","gender","contact","dob","doj","pass","utype","address","salary"),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set)#this is sone to activate the scroll
            ...
            if self.var_emp_id.get()=="":
                ...
                if row==None:
                    ...
                    if op==True :
                        ...
                        con.commit()
                        messagebox.showinfo("Delte","Employee deleted successfully",parent=self.root)
                        self.clear()
