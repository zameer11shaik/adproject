...
class categoryClass:
    def __init__(self,root):
        ...
        self.cateory_table=ttk.Treeview(cat_frame,columns=("cid","name"),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set)#this is sone to activate the scroll
        ...
        self.cateory_table.column("name",width=90)
